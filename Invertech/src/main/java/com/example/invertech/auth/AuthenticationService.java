...
import com.example.invertech.config.JwtService;
import com.example.invertech.token.Token;
import com.example.invertech.token.TokenRepository;
import com.example.invertech.token.TokenType;
import com.example.invertech.user.Role;
import com.example.invertech.user.User;
import com.example.invertech.user.UserRepository;
    ...
    public AuthenticationResponse authenticate(AuthenticationRequest request) {
        ...
        try{
            ...
            return AuthenticationResponse.builder()
                    .accessToken("")
                    .refreshToken("")
                    .message("Error: error de autenticacion")
                    .build();
        }
    }
